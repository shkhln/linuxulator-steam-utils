...
FAKE(pa_channel_map_can_lfe_balance);
...
FAKE(pa_context_send_message_to_object);
...
FAKE(pa_cvolume_get_lfe_balance);
...
FAKE(pa_ext_stream_restore_delete);
...
FAKE(pa_format_info_get_channel_map);
FAKE(pa_format_info_get_channels);
...
FAKE(pa_format_info_get_rate);
FAKE(pa_format_info_get_sample_format);
