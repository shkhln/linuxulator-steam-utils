...
.endfor
	...
	install lxbin/curl-config lxbin/dbus-launch lxbin/file* lxbin/tar lxbin/lsu-* lxbin/python3 lxbin/upgrade-steam-runtime* lxbin/xrandr lxbin/zenity $(PREFIX)/$(PROJECT)/lxbin
